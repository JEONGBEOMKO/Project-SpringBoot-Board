        ...
        QuerydslBinderCustomizer<QArticle>
{
    ...
    Page<Article> findByFileId(String fileId, Pageable pageable);
   ...
   default void customize(QuerydslBindings bindings, QArticle root){
        ...
        bindings.including(root.title,root.content, root.fileId, root.hashtag, root.createdAt, root.createdBy);
